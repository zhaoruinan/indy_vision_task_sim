...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # MoveIt2 move_group action server : to 1
        ...
        # JointTrajectory bridge (ROS2 -> IGN) : 5
        Node(package='ros_ign_bridge',
             executable='parameter_bridge',
        ...
        # JointTrajectoryProgress bridge (IGN -> ROS2) : 6
        Node(package='ros_ign_bridge',
             executable='parameter_bridge',
